      ...
      >
        ...
        <section id="brandlete" className="reveal-on-scroll flex scroll-mt-24 flex-col gap-6">
          <div className="flex flex-col gap-3">
            ...
            <p className="on-photo max-w-2xl text-base leading-7 text-black dark:text-white">
              One connected platform for the coaches, athletes, families, and
              organizations that run youth sports, with Max, our built-in AI
              assistant, alongside.
            </p>
          </div>
          ...
          {/* Hiring — one calm CTA */}
          <div className="flex flex-col gap-3 rounded-xl border border-[#00ccff]/40 bg-[#00ccff]/[0.07] p-4 sm:flex-row sm:items-center sm:justify-between sm:gap-5">
